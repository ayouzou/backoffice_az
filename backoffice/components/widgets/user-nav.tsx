...
const LoggedInContent = () => {
    ...
    return (
        <DropdownMenuContent className="w-56" align="end" forceMount>
            ...
            <DropdownMenuItem className="cursor-pointer" onClick={() => clickLogout()}>
                Log out
